...
**Figure 2: Genomic distribution map showing identified CHG DMR counts across chromosomes for each developmental contrast**

![Genome wide DMR distribution for CHH context](Images/CHH_DMR_Density_Composite_2x2.png)

**Figure 2: Genomic distribution map showing identified CHH DMR counts across chromosomes for each developmental contrast**
